...
const configSetup = {
    ...
    params: {
        ...
        users: {
            administrator: {
                username: 'admin',
                password: 'Connect2017!',
                displayName: 'Administrator',
            },
            user: {
                username: 'user6',
                password: 'Connect2018!',
                displayName: 'User',
            },
        },
        apiUrls: {
        ...
        testrail: {
            projectId: process.env.TESTRAIL_PROJECT_ID || setupUtilities.getParam(367, '--params.testrail.projectId', false),
